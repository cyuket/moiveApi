...
news.controller('labController', [
    ...
    function ($scope, $http, $rootScope) {
      ...
      $scope.previous = previous;
       $scope.showMe = false;
		var url = 'https://api.themoviedb.org/3/tv/airing_today?api_key=ea12c869f716552bef3493abf72c3617&language=en-US&page=1'
    ...
    function next() {
      ...
      j = $scope.incre;
      var url = 'https://api.themoviedb.org/3/tv/airing_today?api_key=ea12c869f716552bef3493abf72c3617&language=en-US&page='+$scope.incre;
